...
export default function Sidebar() {
  return (
    <aside className="fixed inset-y-0 left-0 flex-wrap items-center justify-between block w-full p-0 transition-all duration-200 ease-in-out -translate-x-full border-0 shadow-none dark:bg-slate-850 z-990 rounded-2xl lg:translate-x-0 max-w-64 overflow-y-auto">
      <SidebarHeader />
      <Separator />
