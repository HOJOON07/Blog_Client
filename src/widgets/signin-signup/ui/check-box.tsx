...
export const CheckBox = ({ extra, color, id, ...rest }: CheckBoxProps) => {
  return (
    <input
      id={id}
      type="checkbox"
      className={`defaultCheckbox relative flex h-[20px] min-h-[20px] w-[20px] min-w-[20px] appearance-none items-center
      justify-center rounded-md border border-primary/60 outline-none transition duration-[0.2s]
      checked:border-none checked:bg-primary hover:cursor-pointer checked:text-black ${
        color === 'red'
